        ...
        <Tabs defaultValue="general">
          ...
          <div className="p-4 space-y-5">
            <TabsContent value="general" className="mt-0 space-y-5">
              <div>
                <p className="text-xs font-semibold text-muted-foreground/60 mb-2.5">
                  Appearance
                </p>
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div className="p-3 bg-secondary/30 rounded-lg border border-border/10">
                    ...
                    <div className="flex items-center gap-2">
                      <span
                        className={`w-1.5 h-1.5 rounded-full ${health?.database === "online" ? "bg-success" : "bg-destructive"}`}
                      />
                  ...
                  <div className="p-3 bg-secondary/30 rounded-lg border border-border/10">
                    ...
                    <div className="flex items-center gap-2">
                      <span
                        className={`w-1.5 h-1.5 rounded-full ${health?.discord.includes("online") ? "bg-success" : "bg-destructive"}`}
                      />
                      <span className="text-xs font-semibold">
                  ...
                  <div className="grid grid-cols-3 gap-3 text-xs pt-3 border-t border-border/10">
                    ...
                    <div className="text-center">
                      <p className="font-semibold">
                        {formatBytes(stats?.avgFileSize || 0)}
                      </p>
